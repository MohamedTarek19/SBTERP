...
class AccountsDaily extends StatefulWidget {

  const AccountsDaily({Key? key}) : super(key: key);
  @override
  State<AccountsDaily> createState() => _AccountsDailyState();
}

class _AccountsDailyState extends State<AccountsDaily> {

  var landingInex = 0;
  var currentAppBarText = ['القيود'];
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ServiceWidget(
                        ...
                        name: "",
                        action: () {
                          Navigation.puchNav(DailyReports(), context);
                        },
                      ),
                    ],
                  ),
