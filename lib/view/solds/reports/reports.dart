...
class SoldReports extends StatefulWidget {

  const SoldReports({Key? key}) : super(key: key);
  @override
  State<SoldReports> createState() => _SoldReportsState();
}

class _SoldReportsState extends State<SoldReports> {
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      ServiceWidget(
                        imahePath: "assets/repsacash.png",
                        name: "",
                        action: () {},
                      ),
                      ServiceWidget(
                        imahePath: "assets/repsacredit.png",
                        name: "",
                        action: () {},
                      ),
                    ],
