...
class PurchasesInvoice extends StatefulWidget {
  const PurchasesInvoice({Key? key}) : super(key: key);

  @override
  State<PurchasesInvoice> createState() => _PurchasesInvoiceState();
}

class _PurchasesInvoiceState extends State<PurchasesInvoice> {
  DateTime? Date;
  String? stockName;
  String? source;
  String? sourceName;
