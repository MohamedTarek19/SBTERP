...
class DeffictPermission extends StatefulWidget {
  const DeffictPermission({Key? key}) : super(key: key);

  @override
  State<DeffictPermission> createState() => _DeffictPermissionState();
}

class _DeffictPermissionState extends State<DeffictPermission> {
  DateTime? Date;
  String? stockName;
  ...
  Widget build(BuildContext context) {
    var landingInex = 0;
    var currentAppBarText = ['إذن تالف'];
