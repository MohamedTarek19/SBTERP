...
class AddingPermission extends StatefulWidget {
  const AddingPermission({Key? key}) : super(key: key);

  @override
  State<AddingPermission> createState() => _AddingPermissionState();
}

class _AddingPermissionState extends State<AddingPermission> {
  DateTime? Date;
  String? stockName;
  String? source;
  String? sourceName;
  ...
  Widget build(BuildContext context) {
    var landingInex = 0;
    var currentAppBarText = ['إذن أضافة'];
